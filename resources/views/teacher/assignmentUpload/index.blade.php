                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-success btn-xs">Approeved</button>
                                    @else
                                    <button class="btn btn-danger btn-xs">Pending</button>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ url('upload_assignment/' . $assignment->id . '/edit') }}" class="btn btn-warning btn-xs mr-3" data-toggle="tooltip" title="Edit" style="display:inline;padding:2px 5px 3px 5px;">
