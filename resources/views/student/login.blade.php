...
<body id="page-top" style="background-color: #f2f0f0 !important;">
    <div class="container">
        ...
        <div class="row justify-content-center" style="padding-top: 150px;">
            <a href="/"><img src="{{ asset('assets/img/wingslogo.png') }}" style="padding-right: 25px;" alt="Wings"></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    @endif
                                    <form action="{{ route('student_login') }}" method="post" class="user">
                                        @csrf
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{route('register.form')}}">Create new one!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
