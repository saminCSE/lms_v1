...
<html lang="en">
  <head>
    ...
    <link
      ...
      sizes="180x180"
      href="assets/images/favicons/wingslogo-without-text-180.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="32x32"
      href="assets/images/favicons/wingslogo-without-text-32.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
      href="assets/images/favicons/wingslogo-without-text-16.png"
    />
    <link rel="manifest" href="assets/images/favicons/site.webmanifest" />
    <meta
      name="description"
      content="Eduact HTML Template For Educaton & LMS"
    />
    ...
    <link
      rel="stylesheet"
      href="assets/landingVendor/bootstrap/css/bootstrap.min.css"
    />
    <link
      rel="stylesheet"
      href="assets/landingVendor/bootstrap-select/bootstrap-select.min.css"
    />
    <link rel="stylesheet" href="assets/landingVendor/jquery-ui/jquery-ui.css" />
    <link rel="stylesheet" href="assets/landingVendor/animate/animate.min.css" />
    <link rel="stylesheet" href="assets/landingVendor/fontawesome/css/all.min.css" />
    <link rel="stylesheet" href="assets/landingVendor/eduact-icons/style.css" />
    <link rel="stylesheet" href="assets/landingVendor/jarallax/jarallax.css" />
    <link
      rel="stylesheet"
      href="assets/landingVendor/jquery-magnific-popup/jquery.magnific-popup.css"
    />
    <link
      rel="stylesheet"
      href="assets/landingVendor/nouislider/nouislider.min.css"
    />
    <link
      rel="stylesheet"
      href="assets/landingVendor/nouislider/nouislider.pips.css"
    />
    <link rel="stylesheet" href="assets/landingVendor/odometer/odometer.min.css" />
    <link
      rel="stylesheet"
      href="assets/landingVendor/tiny-slider/tiny-slider.min.css"
    />
    <link
      rel="stylesheet"
      href="assets/landingVendor/owl-carousel/assets/owl.carousel.min.css"
    />
    <link
      rel="stylesheet"
      href="assets/landingVendor/owl-carousel/assets/owl.theme.default.min.css"
    />
  ...
  <body class="custom-cursor">
    ...
    <div class="preloader">
      <div
        ...
        style="background-image: url(assets/images/wingslogo-loader.png)"
      ></div>
    </div>
    <!-- /.preloader -->
    <div class="page-wrapper">
          ...
          <div class="container">
            ...
            <div class="main-menu__nav">
              <ul class="main-menu__list">
                <li class="dropdown">
                  ...
                  <a href="index.html">About WINGS</a>
                  <ul>
            ...
            <div class="main-menu__right">
              ...
              <a href="#" class="main-menu__login">
                <i class="icon-account-1"></i> </a
              ><!-- /.login btn -->
              <a href="#" class="eduact-btn"
                ><span class="eduact-btn__curve"></span>Get In Touch</a
              ><!-- /.contact btn -->
      ...
      <section
        class="hero-banner"
        style="background-image: url(assets/images/shapes/banner-bg-1.png)"
      >
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <div class="hero-banner__content">
                <div
                  class="hero-banner__bg-shape1 wow zoomIn"
                  data-wow-delay="300ms"
                >
                  <div class="hero-banner__bg-round">
                    <div class="hero-banner__bg-round-border">
                      <img
                        src="assets/images/favicons/wingslogo-without-text-32-2.png"
                        alt=""
                      />
                    </div>
                  </div>
                ...
                <h2
                  class="hero-banner__title wow fadeInUp"
                ...
                <p
                  class="hero-banner__text wow fadeInUp"
                  data-wow-delay="500ms"
                >
                  At 'WINGS Learning Centre', we don't just help you pass IELTS
                  <br />
                  We empower you to soar through the skies of English
                  proficiency!
                  <img
                    src="assets/images/shapes/banner-2-shape-2_2.png"
                    alt="eduact"
                  />
                </p>
                <div
                  class="hero-banner__btn wow fadeInUp"
                  data-wow-delay="600ms"
                >
                  <a href="#" class="eduact-btn eduact-btn-second"
                    ><span class="eduact-btn__curve"></span>Take Now<i
                      class="icon-arrow"
                    ></i
                  ></a>
                  <a href="#" class="eduact-btn">
                    <span class="eduact-btn__curve"></span>Find The Course
                    <!-- <span class="eduact-btn__text">Find The Course</span> -->
            ...
            <div class="col-lg-6">
              <div
                class="hero-banner__thumb wow fadeInUp"
                data-wow-delay="700ms"
              >
                <img
                  src="assets/images/resources/banner-1-1.1.png"
                  alt="eduact"
                />
                <div
                  class="hero-banner__cap wow slideInDown"
                  data-wow-delay="800ms"
                >
                  <img src="assets/images/shapes/banner-cap.png" alt="eduact" />
                </div>
                <!-- banner-cap -->
                <div
                  class="hero-banner__star wow slideInDown"
                  data-wow-delay="850ms"
                >
                  <img
                    src="assets/images/shapes/banner-star.png"
                    alt="eduact"
                  />
                </div>
                <!-- banner-star -->
                <div
                  class="hero-banner__map wow slideInDown"
                ...
                <!-- banner-map -->
                <div
                  class="hero-banner__video wow zoomIn"
                  data-wow-delay="950ms"
                  style="
                    background-image: url(assets/images/resources/banner-video-2.png);
                  "
                >
                  <a
                    href="https://www.youtube.com/watch?v=kGK6Sa_TmAY"
                    class="video-popup"
                ...
                <!-- banner-video -->
                <div
                  class="hero-banner__book wow slideInUp"
                  data-wow-delay="1000ms"
                >
                  <img
                    src="assets/images/shapes/banner-book.png"
                    alt="eduact"
                  />
                </div>
                <!-- banner-book -->
                <div
                  class="hero-banner__star2 wow slideInUp"
                  data-wow-delay="1050ms"
                >
                  <img
                    src="assets/images/shapes/banner-star2.png"
                    alt="eduact"
                  />
                </div>
                <!-- banner-star -->
                <div
                  class="hero-banner__cart wow slideInUp"
                  data-wow-delay="1100ms"
                >
                  <div class="hero-banner__cart__thumb">
                    <img
                      src="assets/images/resources/banner-author_2.png"
                      alt="eduact"
                    />
                  </div>
                  <div class="hero-banner__cart__content">
                    <div class="hero-banner__cart__content-inner">
                      ...
                      <p class="hero-banner__cart__text">IELTS</p>
                      <a href="shop.html" class="eduact-btn"
                        ><span class="eduact-btn__curve"></span>Join Now<i
                          class="icon-arrow"
                        ></i
                      ></a>
                      <svg
                      ...
                      >
                        <path
                          d="M0.702945 55.648L108.145 0.179688L87.0803 78.7928L0.702945 55.648Z"
                        />
                      </svg>
                    </div>
                  </div>
        ...
        <div
          class="hero-banner__border wow fadeInUp"
          data-wow-delay="1100ms"
        ></div>
        <!-- banner-border -->
      </section>
      ...
      <section class="service-one">
        <div
          class="service-one__bg"
          id="service-one-image"
          style="background-image: url(assets/images/shapes/service-bg-1.png)"
        ></div>
        <div class="container">
          <div class="row">
              ...
              <div class="service-one__item">
                <div class="service-one__wrapper">
                  ...
                  <p class="service-one__text">
                    Lorem ipsum dolor sit amet consectetur. Convallis ornare
                    semper id hendrerit diam. Mauris cursus suscipit
                  </p>
                  <!-- /.service-content -->
                  <a class="service-one__rm" href="team.html"
                    >Read More<span class="icon-caret-right"></span
                  ></a>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 118 129"
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
              <div class="service-one__item">
                <div class="service-one__wrapper">
                  ...
                  <!-- /.service-icon -->
                  <h3 class="service-one__title">
                    <a href="team-become.html">IELTS Tips & Tricks</a>
                  </h3>
                  <!-- /.service-title -->
                  <p class="service-one__text">
                    Lorem ipsum dolor sit amet consectetur. Convallis ornare
                  ...
                  <!-- /.service-content -->
                  <a class="service-one__rm" href="team-become.html"
                    >Read More<span class="icon-caret-right"></span
                  ></a>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
              <div class="service-one__item">
                <div class="service-one__wrapper">
                  ...
                  <!-- /.service-content -->
                  <a class="service-one__rm" href="course.html"
                    >Read More<span class="icon-caret-right"></span
                  ></a>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="400ms">
              <div class="service-one__item">
                <div class="service-one__wrapper">
                  ...
                  <!-- /.service-icon -->
                  <h3 class="service-one__title">
                    <a href="about.html">Our Achievements</a>
                  </h3>
                  <!-- /.service-title -->
                  <p class="service-one__text">
                    Lorem ipsum dolor sit amet consectetur. Convallis ornare
                  ...
                  <!-- /.service-content -->
                  <a class="service-one__rm" href="about.html"
                    >Read More<span class="icon-caret-right"></span
                  ></a>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <section class="about-one">
        <div class="container">
          <div class="row">
            <div class="col-xl-6">
              <div
                class="about-one__thumb wow fadeInLeft"
                data-wow-delay="100ms"
              >
                <!-- about thumb start -->
                <div
                  class="about-one__thumb__one eduact-tilt"
                  data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 2, "speed": 700, "scale": 1 }'
                >
                  <img
                    src="assets/images/resources/about-1-1_2.png"
                    alt="eduact"
                  />
                </div>
                <div
                  class="about-one__thumb__shape1 wow zoomIn"
                  data-wow-delay="300ms"
                >
                  <img
                ...
                <div
                  class="about-one__thumb__shape2 wow zoomIn"
                  data-wow-delay="400ms"
                >
                  <img
                ...
                <div
                  class="about-one__thumb__box wow fadeInLeft"
                  data-wow-delay="600ms"
                >
                  <div class="about-one__thumb__box__icon">
                    <span class="icon-Headphone-Women"></span>
                  </div>
                  <h4 class="about-one__thumb__box__title">
                    Need to Know More Details?
                  </h4>
                  <p class="about-one__thumb__box__text">
                    <a href="tel:6845550102">+(880) 187-774-0088</a>
                  </p>
                </div>
              </div>
              <!-- about thumb end -->
            ...
            <div class="col-xl-6">
              <div class="about-one__content">
                ...
                <!-- /.icon-box -->
                <a href="about.html" class="eduact-btn"
                  ><span class="eduact-btn__curve"></span>Discover More<i
                    class="icon-arrow"
                  ></i></a
                ><!-- /.btn -->
              </div>
      ...
      <section
        class="category-one"
        id="category-image-one"
        style="background-image: url(assets/images/shapes/category-bg-1.jpg)"
      >
        <div class="container">
          <div class="section-title text-center">
            ...
            <h2 class="section-title__title">
              Our selection of courses at WLC.
            </h2>
          </div>
          <!-- section-title -->
          <div
            class="category-one__slider eduact-owl__carousel owl-with-shadow owl-theme owl-carousel"
            data-owl-options='{
            "items": 4,
            "margin": 30,
            "smartSpeed": 700,
          ...
          >
            <div class="item">
              <div class="category-one__item">
                <div
                  class="category-one__wrapper"
                  style="
                    background-image: url(assets/images/shapes/category-shape.png);
                  "
                >
                  <div class="category-one__thumb">
                    <img
                      src="assets/images/category/category-normal-1_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- /.category-thumb -->
                  <div class="category-one__content">
                    ...
                    <!-- /.category-icon -->
                    <h3 class="category-one__title">
                      English Language Courses
                    </h3>
                    <!-- /.category-title -->
                    <p class="category-one__text">2 Courses</p>
                    <!-- /.category-content -->
                  </div>
                </div>
                <div class="category-one__hover">
                  <div class="category-one__hover__thumb">
                    <img
                      src="assets/images/category/category-hover-1_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- /.category-thumb -->
                  <div class="category-one__hover__content">
                    ...
                    <h3 class="category-one__hover__title">
                      <a href="about.html">English Language Courses</a>
                    </h3>
                    <!-- /.category-title -->
                    <p class="category-one__hover__text">2 Courses</p>
                    <!-- /.category-content -->
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="category-one__item">
                ...
                >
                  <div class="category-one__thumb">
                    <img
                      src="assets/images/category/category-normal-2_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- /.category-thumb -->
                ...
                <div class="category-one__hover">
                  <div class="category-one__hover__thumb">
                    <img
                      src="assets/images/category/category-hover-2_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- /.category-thumb -->
                  <div class="category-one__hover__content">
                    ...
                    <!-- /.category-icon -->
                    <h3 class="category-one__hover__title">
                      <a href="about.html">Chinese Language Courses</a>
                    </h3>
                    <!-- /.category-title -->
            ...
            <div class="item">
              <div class="category-one__item">
                ...
                >
                  <div class="category-one__thumb">
                    <img
                      src="assets/images/category/category-normal-3_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- /.category-thumb -->
                ...
                <div class="category-one__hover">
                  <div class="category-one__hover__thumb">
                    <img
                      src="assets/images/category/category-hover-3_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- /.category-thumb -->
                  <div class="category-one__hover__content">
                    ...
                    <!-- /.category-icon -->
                    <h3 class="category-one__hover__title">
                      <a href="about.html">O Level Preparation Courses</a>
                    </h3>
                    <!-- /.category-title -->
                    <p class="category-one__hover__text">2 Courses</p>
                    <!-- /.category-content -->
            ...
            <div class="item">
              <div class="category-one__item">
                ...
                >
                  <div class="category-one__thumb">
                    <img
                      src="assets/images/category/category-normal-4_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- /.category-thumb -->
                ...
                <div class="category-one__hover">
                  <div class="category-one__hover__thumb">
                    <img
                      src="assets/images/category/category-hover-4_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- /.category-thumb -->
                  <div class="category-one__hover__content">
                    ...
                    <!-- /.category-icon -->
                    <h3 class="category-one__hover__title">
                      <a href="about.html">IELTS Preparation Courses</a>
                    </h3>
                    <!-- /.category-title -->
                    <p class="category-one__hover__text">6 Courses</p>
                    <!-- /.category-content -->
      ...
      <section
        class="course-one"
        id="course-one-image"
        style="background-image: url(assets/images/shapes/course-bg-1.png)"
      >
        <div class="container">
          <div class="section-title text-center">
            <h5 class="section-title__tagline">
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
              <div class="course-one__item">
                <div class="course-one__thumb">
                  <img
                    src="assets/images/course/course-1-1_2.png"
                    alt="eduact"
                  />
                  <a class="course-one__like" href="javascript:void(0);"
                    ><span class="icon-like"></span
                  ></a>
                </div>
                <!-- /.course-thumb -->
                <div class="course-one__content">
                  <div class="course-one__time">40+ Classes</div>
                  ...
                  <h3 class="course-one__title">
                    <a href="management-consulting.html">IELTS...</a>
                  </h3>
                  <div class="course-one__bottom">
                    <div class="course-one__author">
                      <img
                        src="assets/images/course/author-1_2.png"
                        alt="eduact"
                      />
                      <h5 class="course-one__author__name">Faculty Name</h5>
                      <p class="course-one__author__designation">Designation</p>
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="200ms">
              <div class="course-one__item">
                <div class="course-one__thumb">
                  <img
                    src="assets/images/course/course-1-2_2.png"
                    alt="eduact"
                  />
                  <a class="course-one__like" href="javascript:void(0);"
                    ><span class="icon-like"></span
                ...
                <!-- /.course-thumb -->
                <div class="course-one__content">
                  <div class="course-one__time">80+ Classes</div>
                  <div class="course-one__ratings">
                    <span class="icon-star"></span
                    ><span class="icon-star"></span
                    ><span class="icon-star"></span
                  ...
                  <h3 class="course-one__title">
                    <a href="web-development.html">IELTS...</a>
                  </h3>
                  <div class="course-one__bottom">
                    <div class="course-one__author">
                      <img
                        src="assets/images/course/author-2_2.png"
                        alt="eduact"
                      />
                      <h5 class="course-one__author__name">Faculty Name</h5>
                      <p class="course-one__author__designation">Designation</p>
            ...
            <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="300ms">
              <div class="course-one__item">
                <div class="course-one__thumb">
                  <img
                    src="assets/images/course/course-1-3_2.png"
                    alt="eduact"
                  />
                  <a class="course-one__like" href="javascript:void(0);"
                    ><span class="icon-like"></span
                ...
                <!-- /.course-thumb -->
                <div class="course-one__content">
                  <div class="course-one__time">120+ Classes</div>
                  <div class="course-one__ratings">
                    <span class="icon-star"></span
                    ><span class="icon-star"></span
                    ><span class="icon-star"></span
                  ...
                  <h3 class="course-one__title">
                    <a href="frontend-development.html">IELTS...</a>
                  </h3>
                  <div class="course-one__bottom">
                    <div class="course-one__author">
                      <img
                        src="assets/images/course/author-3_2.png"
                        alt="eduact"
                      />
                      <h5 class="course-one__author__name">Faculty Name</h5>
                      <p class="course-one__author__designation">Designation</p>
            ...
            <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="400ms">
              <div class="course-one__item">
                <div class="course-one__thumb">
                  <img
                    src="assets/images/course/course-1-4_2.png"
                    alt="eduact"
                  />
                  <a class="course-one__like" href="javascript:void(0);"
                    ><span class="icon-like"></span
                ...
                <div class="course-one__content">
                  ...
                  <h3 class="course-one__title">
                    <a href="uiux-design.html">EGP & Preparation Skills</a>
                  </h3>
                  <div class="course-one__bottom">
                    <div class="course-one__author">
                      <img
                        src="assets/images/course/author-4_2.png"
                        alt="eduact"
                      />
                      <h5 class="course-one__author__name">Faculty Name</h5>
                      <p class="course-one__author__designation">Designation</p>
            ...
            <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="500ms">
              <div class="course-one__item">
                <div class="course-one__thumb">
                  <img
                    src="assets/images/course/course-1-5_2.png"
                    alt="eduact"
                  />
                  <a class="course-one__like" href="javascript:void(0);"
                    ><span class="icon-like"></span
                ...
                <!-- /.course-thumb -->
                <div class="course-one__content">
                  <div class="course-one__time">60+ Classes</div>
                  <div class="course-one__ratings">
                    <span class="icon-star"></span
                    ><span class="icon-star"></span
                    ><span class="icon-star"></span
                  ...
                  <h3 class="course-one__title">
                    <a href="digital-photography.html"
                      >Other Foreign Languages</a
                    >
                  </h3>
                  <div class="course-one__bottom">
                    <div class="course-one__author">
                      <img
                        src="assets/images/course/author-5.png"
                        alt="eduact"
                      />
                      <h5 class="course-one__author__name">Faculty Name</h5>
                      <p class="course-one__author__designation">Designation</p>
            ...
            <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="600ms">
              <div class="course-one__item">
                <div class="course-one__thumb">
                  <img
                    src="assets/images/course/course-1-6_2.png"
                    alt="eduact"
                  />
                  <a class="course-one__like" href="javascript:void(0);"
                    ><span class="icon-like"></span
                ...
                <div class="course-one__content">
                  ...
                  <h3 class="course-one__title">
                    <a href="online-business.html">English Language</a>
                  </h3>
                  <div class="course-one__bottom">
                    <div class="course-one__author">
                      <img
                        src="assets/images/course/author-6_2.png"
                        alt="eduact"
                      />
                      <h5 class="course-one__author__name">Faculty Name</h5>
                      <p class="course-one__author__designation">Designation</p>
      ...
      <section
        class="counter-one"
        style="
          background-image: url(assets/images/shapes/counter-bg-1-dark.jpg);
        "
      >
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6">
              <div
                class="counter-one__shapes wow fadeInUp"
              ...
              <div class="counter-one__area wow zoomIn" data-wow-delay="400ms">
                <h5 class="counter-one__title">
                  Register Now and<br />
                  Get a <span>50% Discount</span>
                </h5>
                <ul
                  class="counter-one__list list-unstyled"
      ...
      <section class="testimonial-one">
        <div class="container">
          ...
          <div class="testimonial-one__area">
            <div
              class="testimonial-one__carousel eduact-owl__carousel owl-with-shadow owl-theme owl-carousel"
              data-owl-options='{
                "items": 1,
                "margin": 0,
                "smartSpeed": 700,
            ...
            >
              ...
              <div class="item">
                <div class="testimonial-one__item">
                  <div class="testimonial-one__author">
                    <img
                      src="assets/images/resources/testimonial-1-author-1_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- testimonial-author -->
                  <div class="testimonial-one__content">
                    <div class="testimonial-one__quote">
                      ...
                      knowledge or skills through the use of digital
                      technologies and the internet. Flexible Classes refers to
                      the process flexible Classes refers to the process
                    </div>
                    <!-- testimonial-quote -->
                    <div class="testimonial-one__meta">
                      <h5 class="testimonial-one__title">Savannah Nguyen</h5>
                      <span class="testimonial-one__designation"
                        >UI/UX Designer</span
                      >
                    </div>
                    <!-- testimonial-meta -->
              ...
              <div class="item">
                <div class="testimonial-one__item">
                  <div class="testimonial-one__author">
                    <img
                      src="assets/images/resources/testimonial-1-author-2_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- testimonial-author -->
              ...
              <div class="item">
                <div class="testimonial-one__item">
                  <div class="testimonial-one__author">
                    <img
                      src="assets/images/resources/testimonial-1-author-3_2.png"
                      alt="eduact"
                    />
                  </div>
                  <!-- testimonial-author -->
            ...
            <div
              class="testimonial-one__thumb wow fadeInUp"
              data-wow-delay="200ms"
            >
              <img
                src="assets/images/resources/testimonial-1_2.png"
                alt="eduact"
              />
              <svg
                viewBox="0 0 612 563"
              ...
              <div
                class="testimonial-one__thumb-pen wow fadeInUp"
                data-wow-delay="400ms"
              >
                <img
      ...
      <section
        class="team-one"
        id="team-one-image"
        style="background-image: url(assets/images/shapes/team-bg-1.png)"
      >
        <div class="container">
          <div
          ...
          >
            ...
            <h2 class="section-title__title">Meet Our Professional Teachers</h2>
          </div>
          <!-- section-title -->
          <div class="row">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
              <div class="team-one__item">
                <div class="team-one__image">
                  <img src="assets/images/team/team-1-1_2.jpg" alt="eduact" />
                </div>
                <!-- /.team-image -->
                <div class="team-one__content">
                  <h3 class="team-one__title">
                    <a href="team-details.html">Faculty Name</a>
                  </h3>
                  <!-- /.team-name -->
                  <span class="team-one__designation">Designation</span
                  ><!-- /.team-designation -->
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
              <div class="team-one__item">
                <div class="team-one__image">
                  <img src="assets/images/team/team-1-2_2.jpg" alt="eduact" />
                </div>
                <!-- /.team-image -->
                <div class="team-one__content">
                  <h3 class="team-one__title">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
              <div class="team-one__item">
                <div class="team-one__image">
                  <img src="assets/images/team/team-1-3_2.jpg" alt="eduact" />
                </div>
                <!-- /.team-image -->
                <div class="team-one__content">
                  <h3 class="team-one__title">
          ...
          <div class="row">
                ...
                <div class="row">
                  <div class="col-md-5">
                    <div class="blog-one__image">
                      <img
                        src="assets/images/blog/blog-1-1_2.jpg"
                        alt="eduact"
                      />
                  ...
                  <div class="col-md-7 d-flex align-items-center">
                    <div class="blog-one__content">
                      <div class="blog-one__cats">
                        <a href="blog-list-right.html">Exam-Preparation</a>
                      </div>
                      <h3 class="blog-one__title">
                        <a href="blog-details-right.html"
                          >IELTS Exam Guideline 2023</a
                        >
                      </h3>
                      <!-- /.blog-title -->
                      <div class="blog-one__meta">
                        <div class="blog-one__meta__author">
                          <img
                            src="assets/images/blog/author-1_2.png"
                            alt="eduact"
                          />
                          <a href="blog-list-right.html">Faculty Name</a>
                          Designation
                        </div>
                        <div class="blog-one__meta__date">26 Mar, 2023</div>
                        <!-- /.blog-date -->
                      </div>
                      <!-- /.blog-meta -->
                    </div>
              ...
              <div class="blog-one__item">
                <div class="row">
                  <div class="col-md-5">
                    <div class="blog-one__image">
                      <img
                        src="assets/images/blog/blog-1-2_2.jpg"
                        alt="eduact"
                      />
                  ...
                  <div class="col-md-7 d-flex align-items-center">
                    <div class="blog-one__content">
                      <div class="blog-one__cats">
                        <a href="blog-list-left.html">Advice</a>
                      </div>
                      <h3 class="blog-one__title">
                        <a href="blog-details-left.html">IELTS Tips & Tricks</a>
                      </h3>
                      <!-- /.blog-title -->
                      <div class="blog-one__meta">
                        <div class="blog-one__meta__author">
                          <img
                            src="assets/images/blog/author-2_2.png"
                            alt="eduact"
                          />
                          <a href="blog-list-left.html">Faculty Name</a>
                          Designation
                        </div>
                        <div class="blog-one__meta__date">28 Mar, 2023</div>
                        <!-- /.blog-date -->
                      </div>
                      <!-- /.blog-meta -->
                    </div>
            ...
            <div class="col-xl-4 wow fadeInRight" data-wow-delay="200ms">
              <div
                class="blog-one__cta"
                style="
                  background-image: url(assets/images/backgrounds/mail-bg-1_2.png);
                "
              >
                <div class="blog-one__cta__icon">
                  <span class="icon-Newsletter"></span>
                </div>
                <h3 class="blog-one__cta__title">
                  Subscribe to Our Newsletter for Daily Updates
                </h3>
                <form
                  class="blog-one__cta__email-box mc-form"
                ...
                >
                  <path
                    d="M-3 0.729858C66.0958 55.5037 149.949 88.4404 237.852 95.334L374.567 106.055C418.278 109.483 452 145.953 452 189.798V351.73H-3V0.729858Z"
                    fill="url(#paint0_linear_214_20)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_214_20"
                      x1="99.2396"
                      y1="17.183"
                      x2="271.488"
                      y2="365.14"
      ...
      <section class="cta-one">
        <div
          class="cta-one__bg"
          style="background-image: url(assets/images/shapes/cta-bg-1-dark.jpg)"
        ></div>
        <div class="container">
          <div class="row">
            <div
              class="col-lg-4 col-md-7 wow fadeInLeft"
              data-wow-delay="200ms"
            >
              <div class="cta-one__left">
                <img src="assets/images/shapes/cta-logo.png" alt="eduact" />
                <h3 class="cta-one__left__title">
                  Skills Certificate From WLC.
                </h3>
                <a href="#" class="eduact-btn eduact-btn-second"
                  ><span class="eduact-btn__curve"></span>Get Start Now<i
                    class="icon-arrow"
                  ></i
                ></a>
              </div>
            ...
            <div class="col-lg-5 col-md-12">
              <div
                class="cta-one__thumb__area wow fadeInUp"
                data-wow-delay="200ms"
              >
                <div
                  class="cta-one__thumb eduact-tilt"
                  data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 4, "speed": 700, "scale": 1 }'
                >
                  <img src="assets/images/resources/cta-1_2.png" alt="eduact" />
                </div>
                <div
                  class="cta-one__thumb__area__dark wow zoomIn"
                  data-wow-delay="400ms"
                ></div>
                <div
                  class="cta-one__thumb__area__shape wow fadeInUp"
                  data-wow-delay="500ms"
                  style="
                    background-image: url(assets/images/shapes/cta-shape-1.png);
                  "
                ></div>
                <svg
                  viewBox="0 0 611 556"
                ...
                >
                  <path
                    d="M555.808 95.8321C526.054 35.589 468.004 11.1869 403.454 20.9135C289.531 38.072 13.8566 185.923 18.9328 335.709C21.1965 402.647 82.6767 445.989 139.184 473.388C225.719 515.342 328.597 544.419 425.405 534.761C459.035 531.405 494.157 521.884 520.961 500.461C549.566 477.6 565.052 440.218 575.067 406.004C587.157 364.666 592.748 319.184 591.976 276.168C590.913 217.123 582.27 149.38 555.808 95.8321Z"
                    fill="url(#paint0_linear_268_9)"
                  />
                  <path
                    d="M387.299 555.447C286.444 555.447 192.226 520.034 130.952 490.324C46.183 449.226 2.16083 397.425 0.0857661 336.342C-5.4706 172.566 282.449 20.0916 400.642 2.28241C410.708 0.758347 420.758 0.00488281 430.498 0.00488281C493.419 0.00488281 545.261 31.8903 572.717 87.4927C596.624 135.886 609.451 199.263 610.823 275.825C611.646 322.078 605.541 368.913 593.159 411.278C584.053 442.427 567.881 487.07 532.742 515.154C506.35 536.234 470.868 549.146 427.274 553.478C414.292 554.797 400.847 555.447 387.299 555.447ZM387.299 552.023C400.744 552.023 414.069 551.372 426.949 550.087C469.873 545.806 504.755 533.152 530.616 512.483C565 484.998 580.915 441.006 589.884 410.319C602.18 368.279 608.234 321.804 607.41 275.894C606.039 199.828 593.348 136.965 569.665 89.0168C542.792 34.6301 492.082 3.42973 430.516 3.42973C420.946 3.42973 411.068 4.1832 401.173 5.67301C283.838 23.3452 -1.9893 174.278 3.49847 336.223C5.52209 395.935 48.9098 446.743 132.444 487.241C193.392 516.798 287.096 552.023 387.299 552.023Z"
                    fill="url(#paint1_linear_268_9)"
                  />
                  <path
                    d="M563.097 141.554C549.446 79.3244 501.565 43.6716 439.948 37.9521C331.153 27.8317 43.6621 101.226 14.1824 240.258C1.01179 302.402 47.7093 356.275 93.4807 394.342C163.57 452.633 251.649 502.807 342.951 515.924C374.678 520.479 409.165 519.709 438.73 506.078C470.285 491.539 493.059 460.664 510.071 431.433C530.633 396.123 546.153 355.539 555.259 315.759C567.744 261.184 575.238 196.865 563.097 141.554Z"
                    fill="url(#paint2_linear_268_9)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_268_9"
                      x1="137.156"
                      y1="59.5939"
                      x2="389.089"
                      y2="514.127"
      ...
      <footer class="main-footer">
        <div
          ...
          id="main-footer-bg-image"
          style="background-image: url(assets/images/shapes/footer-bg-1.png)"
        ></div>
        <div class="container">
          <div class="row">
            <div class="col-xl-3 col-md-5 wow fadeInUp" data-wow-delay="100ms">
              <div class="main-footer__about">
                <a href="index.html" class="main-footer__logo">
                  <img
                    src="assets/images/wingslogo-white.png"
                    alt="eduact"
                    width="111"
                    height="96"
                  /> </a
                ...
                <div class="main-footer__social">
                  <a href="https://www.facebook.com/wlcbd"
                    ><i class="fab fa-facebook-f"></i
                  ></a>
                  <a
                    href="https://www.linkedin.com/company/wings-learning-centre/?originalSubdomain=bd"
                    ><i class="fab fa-linkedin-in"></i
                  ></a>
                  ...
                  ></a>
                  <a
                    href="https://www.youtube.com/channel/UCDPvD8tQXlLe_NLlpI9MhOQ"
                    ><i class="fab fa-youtube"></i
                  ></a>
                </div>
                <!-- /.footer-social -->
              ...
              <div class="main-footer__newsletter">
                ...
                <ul class="main-footer__info-list">
                  ...
                  <li>
                    ...
                    ><a href="tel:3035550105">+(880) 187-774-0088</a>
                  </li>
                  <li>
    ...
    <script src="assets/landingVendor/jquery/jquery-3.5.1.min.js"></script>
    <script src="assets/landingVendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="assets/landingVendor/bootstrap-select/bootstrap-select.min.js"></script>
    <script src="assets/landingVendor/jquery-ui/jquery-ui.js"></script>
    <script src="assets/landingVendor/jarallax/jarallax.min.js"></script>
    <script src="assets/landingVendor/jquery-ajaxchimp/jquery.ajaxchimp.min.js"></script>
    <script src="assets/landingVendor/jquery-appear/jquery.appear.min.js"></script>
    <script src="assets/landingVendor/jquery-circle-progress/jquery.circle-progress.min.js"></script>
    <script src="assets/landingVendor/jquery-magnific-popup/jquery.magnific-popup.min.js"></script>
    <script src="assets/landingVendor/jquery-validate/jquery.validate.min.js"></script>
    <script src="assets/landingVendor/nouislider/nouislider.min.js"></script>
    <script src="assets/landingVendor/odometer/odometer.min.js"></script>
    <script src="assets/landingVendor/tiny-slider/tiny-slider.min.js"></script>
    <script src="assets/landingVendor/owl-carousel/owl.carousel.min.js"></script>
    <script src="assets/landingVendor/wnumb/wNumb.min.js"></script>
    <script src="assets/landingVendor/jquery-circleType/jquery.circleType.js"></script>
    <script src="assets/landingVendor/jquery-lettering/jquery.lettering.min.js"></script>
    <script src="assets/landingVendor/tilt/tilt.jquery.js"></script>
    <script src="assets/landingVendor/wow/wow.js"></script>
    <script src="assets/landingVendor/isotope/isotope.js"></script>
    <script src="assets/landingVendor/countdown/countdown.min.js"></script>
    <script
      type="module"
