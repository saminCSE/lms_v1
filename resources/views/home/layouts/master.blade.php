...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hero-banner__content">
                            <div class="hero-banner__bg-shape1 wow zoomIn" data-wow-delay="300ms">
                                <div class="hero-banner__bg-round">
                                    <div class="hero-banner__bg-round-border">
                                        <img src="assets/images/favicons/wingslogo-without-text-32-2.png"
                                            alt="" />
                                    </div>
                                </div>
                            </div>
                            <h2 class="hero-banner__title wow fadeInUp" data-wow-delay="400ms">
                                {{-- A Better<br />
                                Learning Journey <br />
                                Future Start Here --}}
                                {!! $hero->hero_title !!}
                            ...
                            <p class="hero-banner__text wow fadeInUp" data-wow-delay="500ms">
                                ...
                                <img src="assets/images/shapes/banner-2-shape-2_2.png" alt="eduact" />
                            </p>
                            <div class="hero-banner__btn wow fadeInUp" data-wow-delay="600ms">
                                <a href="#" class="eduact-btn eduact-btn-second"><span
                                        class="eduact-btn__curve"></span>Take Now<i class="icon-arrow"></i></a>
                    ...
                    <div class="col-lg-6">
                        <div class="hero-banner__thumb wow fadeInUp" data-wow-delay="700ms">
                            {{-- <img src="assets/images/resources/banner-1-1.1.png" alt="eduact" /> --}}
                            {{-- <img src="storage/app/public/img/{{ $hero->hero_banner_image }}" alt="eduact" /> --}}
                            <img src="{{ asset('storage/img/' . $hero->hero_banner_image) }}" alt="eduact" />
                            <div class="hero-banner__cap wow slideInDown" data-wow-delay="800ms">
                                <img src="assets/images/shapes/banner-cap.png" alt="eduact" />
                            </div>
                            <!-- banner-cap -->
                            <div class="hero-banner__star wow slideInDown" data-wow-delay="850ms">
                                <img src="assets/images/shapes/banner-star.png" alt="eduact" />
                            </div>
                            <!-- banner-star -->
                            <div class="hero-banner__map wow slideInDown" data-wow-delay="900ms">
                                <img src="assets/images/shapes/banner-map.png" alt="eduact" />
                            </div>
                            <!-- banner-map -->
                            <div class="hero-banner__video wow zoomIn" data-wow-delay="950ms"
                                style="background-image: url(assets/images/resources/banner-video-2.png);">
                                <a href="{{ $hero->hero_video }}" class="video-popup"><span
                                        class="icon-play"></span></a>
                            </div>
                            <!-- banner-video -->
                            <div class="hero-banner__book wow slideInUp" data-wow-delay="1000ms">
                                <img src="assets/images/shapes/banner-book.png" alt="eduact" />
                            </div>
                            <!-- banner-book -->
                            <div class="hero-banner__star2 wow slideInUp" data-wow-delay="1050ms">
                                <img src="assets/images/shapes/banner-star2.png" alt="eduact" />
                            </div>
                            <!-- banner-star -->
                            <div class="hero-banner__cart wow slideInUp" data-wow-delay="1100ms">
                                <div class="hero-banner__cart__thumb">
                                    <img src="assets/images/resources/banner-author_2.png" alt="eduact" />
                                </div>
                                <div class="hero-banner__cart__content">
                                    <div class="hero-banner__cart__content-inner">
                                        ...
                                        <p class="hero-banner__cart__text">{{ $hero->workshop_title }}</p>
                                        <a href="#" class="eduact-btn"><span class="eduact-btn__curve"></span>Join
        ...
        <section class="service-one">
            <div class="service-one__bg" id="service-one-image"
                style="background-image: url(assets/images/shapes/service-bg-1.png)"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="service-one__item">
                            <div class="service-one__wrapper">
                                ...
                                <!-- /.service-content -->
                                <a class="service-one__rm" href="#">Read More<span
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-one__thumb wow fadeInLeft" data-wow-delay="100ms">
                            ...
                            <div class="about-one__thumb__one eduact-tilt"
                                ...
                                <img src="assets/images/resources/about-1-1_2.png" alt="eduact" />
                            </div>
                    ...
                    > --}}
                            ...
                            <!-- /.icon-box -->
                            <a href="#" class="eduact-btn"><span class="eduact-btn__curve"></span>Discover
        ...
        <!-- About End -->
        <!-- Category Start -->
        <section class="category-one" id="category-image-one"
            ...
            "responsive":{
                ...
                "1400":{
                    ...
                    @foreach ($programs as $programData)
                        @if ($programData->is_active && $programData->courses_count > 0)
                            <div class="item">
                                <div class="category-one__item">
                                    <div class="category-one__wrapper"
                                        style="background-image: url(assets/images/shapes/category-shape.png);">
                                        <div class="category-one__thumb">
                                            {{-- <img src="assets/images/category/category-normal-1_2.png" alt="eduact" /> --}}
                                        ...
                                        <div class="category-one__content">
                                            ...
                                            <p class="category-one__text">
                                                {{-- {{ $coursesCountArray[$programData->id] }} --}}
                                                {{ $programData->courses_count }} Courses</p>
                                            <!-- /.category-content -->
                                        </div>
                                    </div>
                                    <div class="category-one__hover">
                                        <div class="category-one__hover__thumb">
                                            {{-- <img src="assets/images/category/category-hover-1_2.png" alt="eduact" /> --}}
                                        ...
                                        <div class="category-one__hover__content">
                                            ...
                                            <!-- /.category-title -->
                                            <p class="category-one__hover__text">
                                                {{-- {{ $coursesCountArray[$programData->id] }} --}}
                                                {{ $programData->courses_count }} Courses</p>
                                            <!-- /.category-content -->
                                        </div>
        ...
        <!-- Category End -->
        <!-- Course Start -->
        <section class="course-one" id="course-one-image"
            ...
            <div class="container">
                ...
                <div class="row">
                    @foreach ($courses as $coursesData)
                        @if ($coursesData->is_active && isset($coursesData->batchName))
                            <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                <div class="course-one__item">
                                    <div class="course-one__thumb">
                                        {{-- <img src="assets/images/course/course-1-1_2.png" alt="eduact" /> --}}
                                        <img src="{{ asset('storage/img/' . $coursesData->course_image_1) }}"
                                            alt="eduact" />
                                        <a class="course-one__like" href="javascript:void(0);"><span
                                                class="icon-like"></span></a>
                                    </div>
                                    <!-- /.course-thumb -->
                                    <div class="course-one__content">
                                        ...
                                        <h3 class="course-one__title">
                                            <a
                                                href="{{ route('course_details', ['course_id' => $coursesData->id]) }}">
                                                {{ $coursesData->name }}
                                            </a>
                                        </h3>
                                        <div class="course-one__bottom mb-3">
                                            <div class="course-one__author">
                                                <img src="assets/images/course/author-1_2.png" alt="eduact" />
                                                <h5 class="course-one__author__name">Faculty Name</h5>
                                                <p class="course-one__author__designation">Designation</p>
                                            </div>
                                            <div class="course-one__meta">
                                                <h4 class="course-one__meta__price">৳ {{ $coursesData->course_price }}
                                                </h4>
                                                <p class="course-one__meta__class">15 Lessons</p>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-center">
                                            <div class="main-footer__social mb-4">
                                                <a href="https://www.facebook.com/sharer/sharer.php?text={{ $coursesData->name }}&amp;u={{ route('course_details', ['course_id' => $coursesData->id]) }}"
                                                    target="_blank"><i class="fab fa-facebook-f"></i></a>
                                                <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('course_details', ['course_id' => $coursesData->id]) }}&amp;title={{ $coursesData->name }}&amp;summary=Course%20Summary"
                                                    target="_blank"><i class="fab fa-linkedin-in"></i></a>
                                                <a href="https://twitter.com/intent/tweet?text={{ $coursesData->name }}&amp;url={{ route('course_details', ['course_id' => $coursesData->id]) }}"
                                                    target="_blank"><i class="fab fa-twitter"></i></a>
                                                <a href="https://wa.me/?text={{ route('course_details', ['course_id' => $coursesData->id]) }}"
                                                    target="_blank"><i class="fab fa-whatsapp"></i></a>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-center">
                                            <form
                                                action="{{ route('checkout_easy', ['course_id' => $coursesData->id]) }}"
                                                method="post">
                                                @csrf
                                                <input type="hidden" name="courseName"
                                                    value="{{ $coursesData->name }}">
                                                <input type="hidden" name="batchName"
                                                    value="{{ $coursesData->batchName }}">
                                                <input type="hidden" name="coursePrice"
                                                    value="{{ $coursesData->course_price }}">
                                                {{-- <button class="btn-danger justify-content-center">Share On</button> --}}
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="200ms">
                        <div class="counter-one__left">
                            ...
                            <a href="#" class="eduact-btn eduact-btn-second"><span
                                    class="eduact-btn__curve"></span>Join Now<i class="icon-arrow"></i></a>
                    ...
                    <div class="col-lg-6">
                        <div class="counter-one__shapes wow fadeInUp" data-wow-delay="200ms">
                            <svg viewBox="0 0 581 596" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_227_946" x1="172.303" y1="27.9012"
                                        x2="521.418" y2="508.929" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#4F5DE4" stop-opacity="0" />
                                        <stop offset="0.269374" stop-color="#9EA6F0" stop-opacity="0.550859" />
                                        <stop offset="1" stop-color="white" stop-opacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint1_linear_227_946" x1="123.876" y1="84.092"
                                        x2="408.261" y2="553.853" gradientUnits="userSpaceOnUse">
                        ...
                        <div class="counter-one__area wow zoomIn" data-wow-delay="400ms">
                            ...
                            <ul class="counter-one__list list-unstyled" data-leading-zeros="true"
                                data-enable-days="true" data-deadline-date="dynamicDate">
                                <!-- loading via js -->
                            </ul>
              ...
              > --}}
                ...
                "navText": ["<span class=\"icon-arrow-left\"></span>","<span class=\"icon-arrow\"></span>"]
                        ...
                        <div class="item">
                            <div class="testimonial-one__item">
                                <div class="testimonial-one__author">
                                    <img src="assets/images/resources/testimonial-1-author-1_2.png" alt="eduact" />
                                </div>
                                <!-- testimonial-author -->
                        ...
                        <div class="item">
                            <div class="testimonial-one__item">
                                <div class="testimonial-one__author">
                                    <img src="assets/images/resources/testimonial-1-author-2_2.png" alt="eduact" />
                                </div>
                                <!-- testimonial-author -->
                                <div class="testimonial-one__content">
                                    <div class="testimonial-one__quote">
                        ...
                        <div class="item">
                            <div class="testimonial-one__item">
                                <div class="testimonial-one__author">
                                    <img src="assets/images/resources/testimonial-1-author-3_2.png" alt="eduact" />
                                </div>
                                <!-- testimonial-author -->
                                <div class="testimonial-one__content">
                                    <div class="testimonial-one__quote">
                    ...
                    <div class="testimonial-one__thumb wow fadeInUp" data-wow-delay="200ms">
                        <img src="assets/images/resources/testimonial-1_2.png" alt="eduact" />
        ...
        <!-- Testimonial End -->
        <!-- Team Start -->
        <section class="team-one" id="team-one-image"
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="team-one__item">
                            ...
                            <div class="team-one__content">
                                ...
                                <!-- /.team-name -->
                                <span class="team-one__designation">Designation</span><!-- /.team-designation -->
            ...
            <div class="container">
              ...
              > --}}
                    ...
                    <div class="col-xl-8 wow fadeInUp" data-wow-delay="200ms">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="blog-one__image">
                                        <img src="assets/images/blog/blog-1-1_2.jpg" alt="eduact" />
                                        <a href="#"></a>
                                    </div>
                                    <!-- /.blog-image -->
                                </div>
                                <div class="col-md-7 d-flex align-items-center">
                                    <div class="blog-one__content">
                                        ...
                                        <h3 class="blog-one__title">
                                            <a href="#">IELTS Exam Guideline 2023</a>
                                        </h3>
                                        <!-- /.blog-title -->
                                        <div class="blog-one__meta">
                                            <div class="blog-one__meta__author">
                                                <img src="assets/images/blog/author-1_2.png" alt="eduact" />
                                                <a href="#">Faculty Name</a>
                                                Designation
                                            </div>
                        ...
                        <div class="blog-one__item">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="blog-one__image">
                                        <img src="assets/images/blog/blog-1-2_2.jpg" alt="eduact" />
                                        <a href="#"></a>
                                    </div>
                                    <!-- /.blog-image -->
                                </div>
                                <div class="col-md-7 d-flex align-items-center">
                                    <div class="blog-one__content">
                                        ...
                                        <div class="blog-one__meta">
                                            <div class="blog-one__meta__author">
                                                <img src="assets/images/blog/author-2_2.png" alt="eduact" />
                                                <a href="#">Faculty Name</a>
                                                Designation
                                            </div>
                ...
                ">
                            ...
                            <form class="blog-one__cta__email-box mc-form" data-url="MC_FORM_URL"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 341" fill="none">
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_214_20" x1="99.2396" y1="17.183"
                                        x2="271.488" y2="365.14" gradientUnits="userSpaceOnUse">
        ...
        <section class="cta-one">
            <div class="cta-one__bg" style="background-image: url(assets/images/shapes/cta-bg-1-dark.jpg)"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-7 wow fadeInLeft" data-wow-delay="200ms">
                        <div class="cta-one__left">
                            ...
                            <a href="{{ route('alumni') }}" class="eduact-btn eduact-btn-second"><span
                                    class="eduact-btn__curve"></span>Alumni Speeches<i class="icon-arrow"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="cta-one__thumb__area wow fadeInUp" data-wow-delay="200ms">
                            <div class="cta-one__thumb eduact-tilt"
                            ...
                            <div class="cta-one__thumb__area__shape wow fadeInUp" data-wow-delay="500ms"
                                style="
                  ...
                  ">
                            ...
                            <svg viewBox="0 0 611 556" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_268_9" x1="137.156" y1="59.5939"
                                        x2="389.089" y2="514.127" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#FF7200" />
                                        <stop offset="1" stop-color="white" stop-opacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint1_linear_268_9" x1="137.275" y1="26.0413"
                                        x2="435.685" y2="537.491" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#FF7200" stop-opacity="0.71" />
                                        <stop offset="1" stop-color="white" stop-opacity="0" />
                                    </linearGradient>
                                    <linearGradient id="paint2_linear_268_9" x1="137.156" y1="59.5939"
                                        x2="389.089" y2="514.127" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#FF7200" />
                                        <stop offset="1" stop-color="white" stop-opacity="0" />
                                    </linearGradient>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="#" aria-label="logo image"><img src="assets/images/wingslogo-white.png"
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/6587e0d570c9f2407f82fb20/1hidcch77';
            s1.charset = 'UTF-8';
