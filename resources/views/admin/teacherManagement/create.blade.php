...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            @if (isset($item))
                {!! Form::model($item, [
                    'route' => ['teacher_management.update', $item->id],
                    'method' => 'PUT',
            ...
            @else
                {!! Form::open([
                    'route' => ['teacher_management.store'],
                    'method' => 'POST',
                    'class' => 'custom-validation',
                    'files' => true,
                    'role' => 'form',
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="form-group">
                            {!! Form::text('TeacherName', isset($item->TeacherName) ? $item->TeacherName : null, [
                                'class' => 'form-control',
                            ]) !!}

                            {!! $errors->first('TeacherName', '<p class="help-block text-danger">:message</p>') !!}
                        </div>
                    </div>
                </div>
                <div class="row">
