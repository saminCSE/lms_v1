...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function setRequiredInfo(array $info)
    {
        ...
        $this->data['tran_id'] = $info['tran_id']; // string (30)	Mandatory - Unique transaction ID to identify your order in both your end and SSLCommerz // string (50)	Mandatory - Mention the product category. It is a open field. Example - clothing,shoes,watches,gift,healthcare, jewellery,top up,toys,baby care,pants,laptop,donation,etc
    ...
    {
        $this->data['cus_name'] = (isset($info['studentId'])) ? $info['studentId'] : null; // string (50)	Mandatory - Your customer name to address the customer in payment receipt email
        $this->data['cus_email'] = (isset($info['studentEmail'])) ? $info['studentEmail'] : null; // string (50)	Mandatory - Valid email address of your customer to send payment receipt from SSLCommerz end
        $this->data['cus_add1'] = (isset($info['address'])) ? $info['address'] : null; // string (50)	Mandatory - Address of your customer. Not mandatory but useful if provided
        ...
        $this->data['cus_phone'] = (isset($info['mobile'])) ? $info['mobile'] : null; // string (20)	Mandatory - The phone/mobile number of your customer to contact if any issue arises
